...
let memo = {
    ...
    basePlayerColor : function(player){
        if(player == 0){
            console.log("player1");
           // base.ledSetFront(globalWorldColor.magenta);
            base.ledSetBack(globalWorldColor.magenta);

        }else{
            console.log("player2");
           // base.ledSetFront(globalWorldColor.cyan);
...
this.currentPlayerScore[1]= 0;
    ...
    render: function (){
        ...
        if(this.state == 0){
            ...
            //
            //notInterSectBlocks = algoBlock.differenceAndIntersect(world.block, this.memorizeBlocks);
